node{
    ...
    stage('git code checkout'){
        try{
            ...
            git 'https://github.com/shashankmadhav/star-agile-insurance-project.git'
        }
        catch(Exception e){
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'aryan.shashank7@gmail.com'
        }
    }
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t shashankmadhav/insure-me:${tagName} ."
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} push shashankmadhav/insure-me:${tagName}"
